...
module.exports = React.createClass({
  ...
  banks: {
    abc: {
      image: require('../bank-list/images/icon_abc@2x.png'),
      text: '中国农业银行'
    },
    boc: {
      image: require('../bank-list/images/icon_boc@2x.png'),
      text: '中国银行'
    },
    ccb: {
      image: require('../bank-list/images/icon_ccb@2x.png'),
      text: '中国建设银行'
    },
    icbc: {
      image: require('../bank-list/images/icon_icbc@2x.png'),
      text: '中国工商银行'
    },
    bcm: {
      image: require('../bank-list/images/icon_bcm@2x.png'),
      text: '交通银行'
    },
    ceb: {
      image: require('../bank-list/images/icon_ceb@2x.png'),
      text: '光大银行'
    },
    cib: {
      image: require('../bank-list/images/icon_cib@2x.png'),
      text: '兴业银行'
    },
    citic: {
      image: require('../bank-list/images/icon_citic@2x.png'),
      text: '中信银行'
    },
    cncb: {
      image: require('../bank-list/images/icon_cncb@2x.png'),
      text: '中信银行（国际）'
    },
    cmb: {
      image: require('../bank-list/images/icon_cmb@2x.png'),
      text: '招商银行'
    },
    cmbc: {
      image: require('../bank-list/images/icon_cmbc@2x.png'),
      text: '民生银行'
    },
    gdb: {
      image: require('../bank-list/images/icon_gdb@2x.png'),
      text: '广东发展银行'
    },
    hxb: {
      image: require('../bank-list/images/icon_hxb@2x.png'),
      text: '华夏银行'
    },
    pab: {
      image: require('../bank-list/images/icon_pab@2x.png'),
      text: '平安银行'
    },
    psbc: {
      image: require('../bank-list/images/icon_psbc@2x.png'),
      text: '中国邮政储蓄银行'
    },
    spdb: {
      image: require('../bank-list/images/icon_spdb@2x.png'),
      text: '浦发银行'
    }
  },
  ...
  getInitialState: function(){
    return {
      banks: this.props.banks || this.banks,
